...
@NoArgsConstructor
@Getter
public class ResponseSewerInfoSmallSeason {
    ...
    @Builder
    public ResponseSewerInfoSmallSeason(int jan_Count, int feb_Count, int mar_Count, int apr_Count, int may_Count, int jun_Count, int july_Count, int aug_Count, int sep_Count, int oct_Count, int nov_Count, int dec_Count) {
        Jan_Count = jan_Count;
        Feb_Count = feb_Count;
        Mar_Count = mar_Count;
        Apr_Count = apr_Count;
